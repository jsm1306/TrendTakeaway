  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="mt-8 bg-gradient-to-br from-slate-300 to-slate-500 text-white py-4 bg-clip-text text-center text-4xl font-medium tracking-tight text-transparent md:text-7xl"
      >
        Find your <br /> Best Product
      </motion.h1>
    </LampContainer>
  );
}
  ...
  return (
    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        ...
        >
          <div className="absolute bottom-0 left-0 w-full h-56 z-20 [mask-image:linear-gradient(to_top,white,transparent)] pointer-events-none" />
        </motion.div>
        <motion.div
          initial={{ opacity: 0.5, width: "15rem" }}
          whileInView={{ opacity: 1, width: "40rem" }}
        ...
        <div className="absolute top-1/2 z-50 h-48 w-full backdrop-blur-md blur-4xl"></div>
