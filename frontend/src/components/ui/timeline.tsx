...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  useEffect(() => {
    if (ref.current) {
      ...
      console.log("Timeline content scrollHeight:", ref.current.scrollHeight);
    }
  }, [ref]);
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        ...
        >
          <motion.div
            ...
            className="absolute inset-x-0 top-0  w-[2px] bg-gradient-to-t from-purple-500 via-blue-500 to-transparent rounded-full shadow-lg"
          />
        </div>
      </div>
    </div>
